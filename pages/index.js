  ...
  return (
    <div>
      ...
      <div class='font-sans-serif'>
        <div class='w-full bg-hero-img h-screen bg-cover'>
          <header>
            <nav class='container flex items-center tracking-wide ml-16 pt-10 2xl:text-2xl xl:text-2xl lg:text-lg md:text-md sm:text-md font-semibold text-white'>
          ...
          <div class='bg-gradient-to-t from-gray-700 via-transparent to-transparent h-screen w-full bg-cover'>
            <div class='text-white text-6xl font-bold tracking-wider text-left ml-16 absolute bottom-10'>
              <p>I CALL ARCHITECTURE THE FROZEN MUSIC</p>
            </div>
          </div>
        </div>
        <section class='container mx-auto p-20 max-h-full'>
          <div class='relative flex flex-col-reverse flex-wrap lg:flex-row items-center gap-16 mt-14 lg:mt-28'>
            ...
            <div class='flex flex-1 flex-col lg:items-start'>
              ...
              <nav class='flex flex-wrap p-3 md:text-4 lg:text-base xl:text-xl lg:text-align cursor-pointer bg-blue-500 hover:bg-blue-700 text-gray-50 rounded-full'>
        ...
        <section class='container mx-auto'>
          ...
          <div class='flex flex-wrap flex-col tracking-wider lg:w-1/2 lg:float-right pt-10 lg:pt-32 pl-16 md:pl-12 pr-20 text-md sm:text-lg md:text-xl lg:text-base xl:text-2xl 2xl:text-xl'>
            ...
            <div>
              <nav class='flex flex-wrap p-3 m-5 justify-center md:text-4 lg:w-1/2 lg:text-base xl:text-xl cursor-pointer bg-blue-500 hover:bg-blue-700 text-gray-50 rounded-full'>
        ...
        <div class='w-screen'>
          <footer class='flex flex-col tracking-wider md:flex-row text-xl font-semibold items:center pb-6 w-screen bg-gray-300 pt-12 mt-5'>
