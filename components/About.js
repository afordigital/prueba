    ...
    <div id='about' className='w-full max-w-7xl mx-auto p-4 pt-20'>
      <div className='w-full grid grid-cols-2'>
        ...
        <div className='col-span-2 md:col-span-1 p-10'>
          <h2 className='mb-5 text-5xl justify-left lg:text-3xl xl:text-5xl xl:mb-4 lg:mb-2 font-semibold tracking-wider text-gray-800'>
            ABOUT ME
          </h2>
          <div>
            <h3 className='text-justify text-md sm:text-lg md:text-xl lg:text-base xl:text-xl 2xl:text-1xl mb-6 text-gray-800'>
